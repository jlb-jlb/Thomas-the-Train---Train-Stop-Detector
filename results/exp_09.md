...
## Model Path
- Model Path: saved_models/train_stop_detector_val_9.joblib

- Full Model Path: saved_models/train_stop_detector_10.joblib

## Confusion Matrix
![Confusion Matrix](img/confusion_matrix_09.png)

## Additional Information
- test_size: 0.2
- seed: 4
- lag_steps: (1, 2, 3, 4, 5, 7, 9, 11, 13, 15)
- model_type: HistGradientBoostingClassifier
- model_params: {'max_depth': 10, 'learning_rate': 0.12, 'class_weight': 'balanced', 'early_stopping': True, 'random_state': 42}
## Features
